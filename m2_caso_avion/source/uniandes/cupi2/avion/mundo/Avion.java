...
public class Avion
{
    ...
    /**
     * TODO: Cuenta el número de sillas económicas, que están ubicadas en la 
    ...
    public int contarSillasEconomicasDesocupadasVentana()
    {
          ...
          for( int i = 0; i < SILLAS_ECONOMICAS; i++ )
          {
              if( sillasEconomicas[ i ].sillaAsignada( ) == false && sillasEconomicas[i].darUbicacion( ) ==  Silla.VENTANA )
              {
                  contador++;
              }
          }
    ...
    /**
     * TODO: Cuenta el número de sillas económicas, que están ubicadas en el 
    ...
    {	
         ...
         for( int i = 0; i < SILLAS_ECONOMICAS; i++ )
         {
             if( sillasEconomicas[ i ].sillaAsignada( ) == false && sillasEconomicas[i].darUbicacion( ) ==  Silla.PASILLO )
             {
                 contador++;
             }
         }
    ...
    /**
     * TODO: Indica si hay por lo menos un cierto numero de sillas económicas 
    ...
    /**
     * TODO: Retorna el número total de sillas ocupadas en el avión
    ...
    /**
     * TODO: Indica si hay dos sillas vacías con la misma ubicación en el avión, *Solo se comparan sillas de la misma clase
    ...
    public boolean hayDosSillasVaciasMismaUbicacion()
    {
        ...
        for(int i = 0; i < SILLAS_EJECUTIVAS-1 && !existe; i++){
            for(int j = i+1; j < SILLAS_EJECUTIVAS && !existe; j++){
        ...
        for(int i = 0; i < SILLAS_ECONOMICAS-1 && !existe; i++){
            for(int j = i+1; j < SILLAS_ECONOMICAS && !existe; j++){
    ...
    /**
     * TODO: Retorna el porcentaje de sillas económicas pares que están ocupadas
